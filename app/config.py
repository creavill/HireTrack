...
class Config:
    """Configuration manager for Hammy the Hire Tracker."""
    ...
    def experience_level(self) -> Dict[str, Any]:
        ...
        return self._config["preferences"].get(
            "experience_level", {"min_years": 1, "max_years": 5, "current_level": "mid"}
        )
    ...
    def cover_letter_config(self) -> Dict[str, Any]:
        ...
        return self._config.get("ai", {}).get(
            "cover_letter", {"max_words": 350, "tone": "professional", "include_metrics": True}
        )
    ...
    def available_statuses(self) -> List[str]:
        ...
        return self._config.get("tracking", {}).get(
            "statuses",
            [
                "new",
                "interested",
